...
!function(e, o) {
    ...
    return w.prototype.init = function() {
        ...
        void 0 === c && (c = o), t.outsideBound = function(e, o) {
            ...
            void 0 === u && (u = "#ffffff");
            var d = n.bordercolor;
            void 0 === d && (d = "rgba(255, 255, 255, 0.4)");
            var s = n.mask;
            ...
            t.ctx.beginPath(), t.ctx.setFillStyle(s), t.ctx.fillRect(0, 0, r, o), t.ctx.fillRect(r, 0, i, a), 
            t.ctx.fillRect(r, a + c, i, o - a - c), t.ctx.fillRect(r + i, 0, e - r - i, o), 
            t.ctx.fill(), l.forEach(function(e) {
            ...
            }), t.ctx.beginPath(), t.ctx.setStrokeStyle(d), t.ctx.setLineWidth(f), t.ctx.moveTo(r + f / 2, a + f / 2), 
            t.ctx.lineTo(r + i - f / 2, a + f / 2), t.ctx.lineTo(r + i - f / 2, a + c - f / 2), 
            t.ctx.lineTo(r + f / 2, a + c - f / 2), t.ctx.lineTo(r + f / 2, a + f / 2), t.ctx.stroke();
        };
